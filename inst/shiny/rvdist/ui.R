...
shinyUI(fluidPage(title = app_title,
  use_apputils(),
	fluidRow(column(12,
		HTML(paste0('<h1>Distributions of Random Variables
			<a href="http://snap.uaf.edu" target="_blank"><img align="right" src="res/snap_acronym_color.svg" height="35px"/></a></h1>'))
	)),
  ...
  fluidRow(
		column(12,
          ...
          hr(),
          contactinfo(snap = "res/snap_color.svg", iarc = "res/iarc.jpg", uaf = "res/uaf.png"),
          br(), br()
				), id = "tsp"
			)
		)
